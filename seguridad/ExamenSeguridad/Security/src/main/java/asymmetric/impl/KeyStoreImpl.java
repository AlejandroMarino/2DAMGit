...
public class KeyStoreImpl implements asymmetric.KeyStore {
    ...
    @Override
    public Either<String, String> storeKeys(X509Certificate cert, PrivateKey pk, User user) {
        ...
        try {
            ...
            Path path = Path.of("Client/data/" + user.getName() + ".pfx");
    ...
    @Override
    public Either<String, PrivateKey> getPrivateKeyFromKeyStore(User user, String passwordStr) {
        Either<String, PrivateKey> result;

        char[] password = passwordStr.toCharArray();
        Path path = Paths.get("Client/data/" + user.getName() + ".pfx");
    ...
    @Override
    public Either<String, X509Certificate> getCertificateFromKeyStore(User user, String passwordStr) {
