...
public class Constants {
    ...
    public static final String HQL_GET_ALL_ORDER_ITEMS = "HQL_GET_ALL_ORDER_ITEMS";
    public static final String HQL_GET_ALL_ORDER_ITEMS_OF_ORDER = "HQL_GET_ALL_ORDER_ITEMS_Of_ORDER";
    public static final String HQL_GET_ORDER_ITEM = "HQL_GET_ORDER_ITEM";
    public static final String HQL_GET_MENU_ITEM_BY_NAME = "HQL_GET_MENU_ITEM_BY_NAME";
